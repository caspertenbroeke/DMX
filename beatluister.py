#!/usr/bin/env python3
"""Beat-luisteraar voor de Zeutekauwn DMXDesk.

Analyseert de muziek met aubio en stuurt elke gevonden beat naar DMXDesk (UDP 127.0.0.1:8091).
...
class Analyse:
    ...
    def reset(self):
        self.tempo = aubio.tempo("default", WIN, HOP, SR)
        self.rest = b""
